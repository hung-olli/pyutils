...
Usage:
    python -m hcommon.cli run --json_conf2 tmp/t.json --run to-del
    or
    python -m hcommon.cli k_fold --call prlab.medical.k_fold.run_one_fold --json_conf config/medicine.json
"""
